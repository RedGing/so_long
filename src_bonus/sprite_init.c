...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/13 15:26:15 by femorell          #+#    #+#             */
/*   Updated: 2023/03/13 15:26:16 by femorell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	wall_draw(t_game *game, t_vector it, t_image *map)
{
	if (it.y == 0 && it.x == 0)
		...
		construct_image(game->buffer, game->pos, *map, game->sprites[3]);
		...
		construct_image(game->buffer, game->pos, *map, game->sprites[4]);
	else if (it.y != 0 && it.x == game->size.x - 1)
